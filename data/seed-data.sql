...
-- Note: on est obligé de supprimer la clé étrangère "bonne réponse" lors de l'ajout des données,
-- car les tables "answer" et "question" sont liées dans les 2 sens
ALTER TABLE
